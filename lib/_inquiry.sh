...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Sistema WABOOT, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] ${YELLOW} Instalar WABOOT\n"
  # printf "   [1] Atualizar \n"
  printf "   [2] Deletar WABOOT \n"
  printf "   [3] Bloquear WABOOT \n"
  printf "   [4] Desbloquear WABOOT \n"
